    ...
    <div className={`${dark ? "dark" : ""} flex flex-col min-h-screen bg-gray-100 dark:bg-[#0f111b]`}>
      ...
      >
        ...
        <div className="flex-1 flex flex-col md:ml-64 transition-all duration-300 max-w-full">
          {/* Top Bar */}
          <div className="fixed top-0 left-0 md:left-64 right-0 h-16 bg-[#0f111b] border-b border-gray-700 px-6 flex items-center justify-between z-50">  <div className="flex items-center gap-4">
              <button
              ...
              <h1 className="text-lg font-bold text-white">Markets & Stocks</h1>
            </div>
